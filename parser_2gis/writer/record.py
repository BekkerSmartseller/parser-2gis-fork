...
# Города — регионы федерального значения (adm_div.type == 'region' == город).
_CITY_REGIONS = {'Москва', 'Санкт-Петербург', 'Севастополь'}

# Суффиксы муниципальных образований в названии округа (district_area).
_DISTRICT_AREA_SUFFIXES = (
    ' городской округ', ' муниципальный округ', ' муниципальный район',
    ' городской округ с', ' район', ' ЗАТО',
)

# Преобразование прилагательного округа в название города-центра.
_DISTRICT_AREA_TO_CITY = {
    'Гурьевский': 'Гурьевск', 'Одинцовский': 'Одинцово',
    'Раменский': 'Раменское', 'Ленинский': 'Видное',
    'Дмитровский': 'Дмитров', 'Пушкинский': 'Пушкино',
    'Рузский': 'Руза', 'Талдомский': 'Талдом',
    'Можайский': 'Можайск', 'Наро-Фоминский': 'Наро-Фоминск',
    'Волоколамский': 'Волоколамск', 'Зеленоградский': 'Зеленоградск',
    'Багратионовский': 'Багратионовск', 'Светловский': 'Светлый',
    'Беловский': 'Белово', 'Жуковский': 'Жуковский',
    'Сергиево-Посадский': 'Сергиев Посад', 'Богородский': 'Ногинск',
    'Краснозерский': 'Краснозерское', 'Новоорский': 'Новоорск',
    'Мытищинский': 'Мытищи', 'Щёлковский': 'Щёлково',
    'Ступинский': 'Ступино', 'Химкинский': 'Химки',
    'Балашихинский': 'Балашиха', 'Красногорский': 'Красногорск',
    'Истринский': 'Истра', 'Домодедовский': 'Домодедово',
    'Солнечногорский': 'Солнечногорск', 'Чеховский': 'Чехов',
    'Каширский': 'Кашира', 'Егорьевский': 'Егорьевск',
    'Мантуровский': 'Мантурово', 'Галичский': 'Галич',
    'Буйский': 'Буй', 'Шарьинский': 'Шарья',
    'Балтийский': 'Балтийск', 'Гвардейский': 'Гвардейск',
    'Гусевский': 'Гусев', 'Черняховский': 'Черняховск',
    'Нестеровский': 'Нестеров', 'Неманский': 'Неман',
    'Полесский': 'Полесск', 'Славский': 'Славск',
    'Ладушкинский': 'Ладушкин', 'Мамоновский': 'Мамоново',
    'Светлогорский': 'Светлогорск', 'Пионерский': 'Пионерский',
    'Советский': 'Советск', 'Калининградский': 'Калининград',
    'Ясненский': 'Ясный', 'Гайский': 'Гай',
    'Кувандыкский': 'Кувандык', 'Медногорский': 'Медногорск',
    'Анжеро-Судженский': 'Анжеро-Судженск', 'Тайгинский': 'Тайга',
    'Мариинский': 'Мариинск', 'Ленинск-Кузнецкий': 'Ленинск-Кузнецкий',
    'Каменский': 'Камень-на-Оби', 'Киржачский': 'Киржач',
    'Орехово-Зуевский': 'Орехово-Зуево', 'Павлово-Посадский': 'Павловский Посад',
    'Воскресенский': 'Воскресенск', 'Коломенский': 'Коломна',
    'Лосино-Петровский': 'Лосино-Петровский', 'Славгородский': 'Славгород',
    'Долгопрудный': 'Долгопрудный', 'Лобня': 'Лобня',
    'Королёв': 'Королёв', 'Котельники': 'Котельники',
    'Лыткарино': 'Лыткарино', 'Фрязино': 'Фрязино',
    'Черноголовка': 'Черноголовка', 'Электросталь': 'Электросталь',
    'Яровое': 'Яровое', 'Бронницы': 'Бронницы', 'Дубна': 'Дубна',
    'Клин': 'Клин', 'Подольск': 'Подольск', 'Реутов': 'Реутов',
    'Серпухов': 'Серпухов', 'Шатура': 'Шатура',
    'Щербинка': 'Щербинка', 'Троицк': 'Троицк',
    'Краснознаменск': 'Краснознаменск', 'Власиха': 'Власиха',
    'Янтарный': 'Янтарный', 'Шаховская': 'Шаховская',
    'Мантурово': 'Мантурово', 'Лосино-Петровский': 'Лосино-Петровский',
}


def _city_from_district_area(district_area: Optional[str]) -> Optional[str]:
    """Извлекает город-центр из названия муниципального округа.

    'Люберцы городской округ' -> 'Люберцы';
    'Гурьевский муниципальный округ' -> 'Гурьевск';
    'ЗАТО Власиха городской округ' -> 'Власиха'."""
    if not district_area:
        return None
    name = district_area.strip()
    if not name:
        return None
    if name.startswith('ЗАТО '):
        name = name[len('ЗАТО '):].strip()
    for suffix in _DISTRICT_AREA_SUFFIXES:
        if name.endswith(suffix):
            name = name[: -len(suffix)].strip()
            break
    if not name:
        return None
    # Прилагательное округа -> город-центр (словарь), иначе имя уже город.
    return _DISTRICT_AREA_TO_CITY.get(name, name)


_SETTLEMENT_PREFIX = re.compile(r'^(?:пос\.?\s*|пгт\.?\s*|п\.г\.т\.?\s*|рп\.?\s*|г\.?\s*|с\.?\s*|д\.?\s*|деревня\s+|село\s+|посёлок\s+|поселок\s+)(.+)$', re.IGNORECASE)


def _city_value(catalog_item: CatalogItem) -> Optional[str]:
    """Город филиала с fallback-цепочкой.

    Порядок:
    1. явный adm_div.type == 'city';
    2. регион федерального значения (Москва/СПб/Севастополь);
    3. город-центр муниципального округа (district_area);
    4. населённый пункт (settlement), очищенный от префикса (пос./пгт/г.);
    5. регион."""
    city = _adm_value(catalog_item, 'city')
    if city:
        return city
    region = _adm_value(catalog_item, 'region')
    if region in _CITY_REGIONS:
        return region
    city = _city_from_district_area(_adm_value(catalog_item, 'district_area'))
    if city:
        return city
    settlement = _adm_value(catalog_item, 'settlement')
    if settlement:
        m = _SETTLEMENT_PREFIX.match(settlement.strip())
        if m:
            return m.group(1).strip() or settlement.strip()
...
def extract_record(catalog_doc: Any) -> Optional[dict[str, Any]]:
    ...
    for group in catalog_item.contact_groups:
        for contact in group.contacts:
            if not contact.type:
                # аномальный контакт без типа — пропускаем (модель уже толерантна)
                continue
